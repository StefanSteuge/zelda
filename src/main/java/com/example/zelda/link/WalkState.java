...
public class WalkState extends LinkState {
	private final static String[] downAnimation	= {"Link walk down 1", "Link walk down 2", "Link walk down 3",
			"Link walk down 6", "Link walk down 5", "Link walk down 4"};
	private final static String[] upAnimation	= {"Link walk up 3", "Link walk up 2", "Link walk up 1",
			"Link walk up 4", "Link walk up 6", "Link walk up 5"};
	private final static String[] leftAnimation	= {"Link walk left 3", "Link walk left 2", "Link walk left 1",
			"Link walk left 4", "Link walk left 5", "Link walk left 6"};
	private final static String[] rightAnimation= {"Link walk right 3", "Link walk right 2", "Link walk right 1",
