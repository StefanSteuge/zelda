...
public class TransState extends LinkState {
	private final static String[] downAnimation	= {"Link stand down", "Link stand down", "Link stand down",
            "Link stand down", "Link stand down", "Link stand down", "Link stand down", "Link stand down",
            "Link stand down", "Link stand down"};
	private final static String[] upAnimation	= {"Link stand up", "Link stand up", "Link stand up",
            "Link stand up", "Link stand up", "Link stand up", "Link stand up", "Link stand up", "Link stand up",
            "Link stand up"};
	private final static String[] leftAnimation	= {"Link stand left", "Link stand left", "Link stand left",
            "Link stand left", "Link stand left", "Link stand left", "Link stand left", "Link stand left",
            "Link stand left", "Link stand left"};
	private final static String[] rightAnimation= {"Link stand right", "Link stand right", "Link stand right",
