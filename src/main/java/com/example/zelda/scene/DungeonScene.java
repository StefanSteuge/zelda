...
public class DungeonScene extends ZeldaScene {
    ...
    public DungeonScene(Game game, String entrance) {
        ...
        int[] dxpos = {67, 66, 437, 438, 401, 401, 379, 376, 401, 401, 323, 323, 340, 341, 291,
                288, 448, 434, 474, 467, 38, 35, 71};
        int[] dypos = {123, 280, 281, 205, 204, 202, 202, 167, 162, 126, 126, 160, 162, 200, 201,
                87, 85, 168, 170, 329, 319, 94, 96};

        wall2 = new Polygon(dxpos, dypos, dypos.length);

        int[] expos = {71, 106, 105, 111, 112, 179, 179, 202, 203, 176, 178, 256, 258, 235, 234,
                288, 273, 106};
        int[] eypos = {96, 97, 122, 122, 204, 203, 202, 201, 164, 162, 125, 123, 163, 164, 201,
                199, 89, 88};
