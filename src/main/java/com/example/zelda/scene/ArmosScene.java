...
public class ArmosScene extends ZeldaScene {
    ...
    public ArmosScene(Game game, String entrance) {
		...
		Polygon leftTreeline = getPolygon();

		int[] bxpos = {237, 508, 507, 241, 258, 273, 283, 282, 304, 327, 352, 389, 402, 402,
				420, 427, 427, 442, 449, 454, 469, 476, 473, 453, 435, 411, 406, 399, 386,
				359, 322, 294, 283, 276, 260, 241, 235};
        int[] bypos = {2, 4, 507, 510, 503, 485, 475, 449, 434, 435, 435, 438, 427, 401, 385,
				376, 354, 338, 325, 300, 290, 283, 264, 245, 213, 165, 149, 120, 120, 119,
				114, 96, 76, 68, 67, 73, 3};

		Polygon rightTreeline = new Polygon(bxpos, bypos, bypos.length);
	...
	private static Polygon getPolygon() {
		int[] axpos = {239, 4, 3, 4, 240, 224, 205, 199, 197, 179, 175, 171, 146, 107, 104, 87,
		...
		int[] aypos = {4, 5, 399, 509, 510, 501, 484, 474, 447, 434, 420, 396, 386, 387, 372, 346,
				326, 299, 281, 262, 186, 166, 142, 124, 99, 116, 111, 4, 5, 508, 510, 499, 486,
				475, 452, 434, 424, 401, 386, 391, 389, 377, 349, 338, 323, 298, 291, 267, 243,
				216, 177, 162, 123, 100, 110, 74, 71, 71, 77, 4};
