...
public class CastleBasementScene extends ZeldaScene {
    ...
    public CastleBasementScene(Game game, String entrance) {
        ...
        var wall1 = new Polygon(wxpos1, wypos1, wypos1.length);

        int[] wxpos2 = {554, 554, 584, 593, 708, 708, 578, 578,664, 671, 646, 646, 736, 736,
                807, 807, 441, 439};
        int[] wypos2 = {313, 334, 334, 341, 341, 369, 369, 405,407, 574, 575, 702, 701, 827,
                827, 902, 902, 600};

        var wall2 = new Polygon(wxpos2, wypos2, wypos2.length);

        int[] wxpos3 = {854, 783, 783, 825, 825, 788, 787, 823, 823, 776, 775, 737, 736, 777,
                776, 783, 783, 706, 706, 799, 799, 792, 791, 799, 799, 763, 764, 868, 868, 909};
        int[] wypos3 = {38, 57, 77, 78, 215, 218, 311, 312, 333, 334, 341,341, 372, 369, 399,
                400, 468, 471, 573, 576, 622, 623, 655, 656, 701, 703, 778, 775, 930, 926};
        ...
        int[] wxpos7 = {447, 447, 432, 432, 417, 417, 352, 352, 337, 337, 323, 323, 187, 192, 145,
                145, 189, 189, 148, 148, 148, 189, 447};
        int[] wypos7 = {421, 368, 368, 359, 359, 336, 338, 358, 358, 365, 365, 377, 377, 366, 366,
                155, 155, 80, 80, 112, 80, 80, 30};
